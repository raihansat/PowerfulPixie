...
(Tidak ada diskon)");
echo "Nama Produk : " . $beli->getName() . "<br/>";
echo "Harga : Rp. " . $beli->getPrice() . ",-<br/>";
echo $beli->getDiscount() . "<br/><hr/>";
$beli_cdm->setArtist("Starset");
$beli_cdm->setGenre("Hardrock");
...
echo "Selamat anda mendapatkan diskon sebesar " . $beli_cdm->getDiscount() .
"<br/>";
echo "Total Harga : Rp." . $beli_cdm->getPrice() . ",-<br/>Harga diatas sudah
termasuk PPN sebesar 10% dan diskon 5%<br/><br/><hr/>";
$beli_cdr->setCapacity("60 CD");
...
echo "Mohon maaf anda tidak mendapatkan diskon <br/>";
echo "Total Harga : Rp." . $beli_cdr->getPrice() . ",-<br/>Harga diatas sudah
termasuk ppn sebesar 15% dan tidak mendapatkan diskon";
?>